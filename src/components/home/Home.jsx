  ...
  return (
    <div className='w-screen h-screen pt-16 pl-10 flex flex-col gap-10 lg:gap-0'>
      ...
      <div className='flex gap-3 sm:gap-5 md:gap-10 px-4 py-8'>
        <button className='text-white text-xl bg-orange-600 px-3 sm:px-10 py-2 rounded-3xl hover:bg-orange-500'>Free Trial</button>
        <button className='text-white text-xl px-3 sm:px-10 py-2 rounded-3xl border-4 border-solid border-orange-600
